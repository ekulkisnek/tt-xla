...
class Qwen25Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen25Model`]. It is used to instantiate a
    Qwen2.5 model according to the specified arguments, defining the model architecture. Instantiating a configuration
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151936):
            ...
            `inputs_ids` passed when calling [`Qwen25Model`]
    ...
    ```python
    >>> from transformers import Qwen25Model, Qwen25Config

    >>> # Initializing a Qwen2.5 style configuration
    >>> configuration = Qwen25Config()

    >>> # Initializing a model from the Qwen2.5-7B style configuration
    >>> model = Qwen25Model(configuration)
